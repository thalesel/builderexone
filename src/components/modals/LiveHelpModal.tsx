...
export const LiveHelpModal = ({ isOpen, onClose, onConfirm }: { isOpen: boolean; onClose: () => void; onConfirm: () => void }) => {
    ...
    return (
        <div className="fixed inset-0 z-[99999] flex items-end md:items-center justify-center overflow-hidden">
            ...
            <div className="relative w-full max-w-md bg-white rounded-t-lg md:rounded-lg p-8 md:p-12 shadow-2xl flex flex-col animate-in slide-in-from-bottom md:zoom-in-95 duration-300 z-[100000]">
                ...
                <div className="text-center space-y-6">
                    <div className="w-20 h-20 bg-red-600 text-white rounded-lg mx-auto flex items-center justify-center shadow-2xl">
                        <ICONS.LiveSupport />
                    </div>
                    <div>
                    ...
                    <Button onClick={onConfirm} variant="live" className="w-full py-4 rounded-lg">Contratar Auxílio (R$ 20,00)</Button>
                </div>
            </div>
        </div>
    );
