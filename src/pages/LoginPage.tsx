...
export const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center md:p-6 bg-zinc-950">
            <div className="bg-white p-8 md:p-12 shadow-2xl w-full md:max-w-md md:border md:border-zinc-800 rounded-none md:rounded-lg relative overflow-hidden min-h-screen md:min-h-fit flex flex-col justify-center">
                ...
                <form onSubmit={handleAuth} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full py-4 rounded-lg" disabled={loading}>
