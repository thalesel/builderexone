...
export const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center md:bg-zinc-100 bg-zinc-950 font-sans">
            <div className="bg-white w-full md:max-w-5xl md:h-[650px] md:shadow-2xl md:rounded-3xl flex flex-col md:flex-row overflow-hidden min-h-screen md:min-h-fit">
                ...
                <div className="hidden md:flex flex-1 relative bg-zinc-950 overflow-hidden group">
                    ...
                    <div className="absolute inset-0 opacity-40">
                        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-zinc-800 rounded-full blur-[100px] animate-pulse"></div>
                        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-zinc-700 rounded-full blur-[120px] animate-pulse delay-700"></div>
                        <div className="absolute top-[20%] right-[30%] w-[40%] h-[40%] bg-zinc-600 rounded-full blur-[90px] animate-pulse delay-500"></div>
                    </div>

                    <div className="relative z-10 p-16 flex flex-col justify-between h-full w-full">
                        <div className="flex items-center gap-3">
                            <img src="/logo.png" alt="Builder Exone" className="h-8 w-auto invert brightness-0" />
                            <span className="text-white font-black tracking-tighter text-xl">BUILDER EXONE</span>
                        </div>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="w-full aspect-square max-w-[320px] mx-auto relative">
                                <img
                                    src="/LOGO.png"
                                    alt="Logo High Res"
                                    className="w-full h-full object-contain drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] group-hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                            <div className="space-y-4">
                                <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.4em]">Personal Hub</p>
                                <h2 className="text-white text-4xl md:text-5xl font-black leading-[1.1] tracking-tighter">
                                    Conecte-se à sua <br />
                ...
                <div className="flex-1 p-8 md:p-16 flex flex-col justify-center bg-white">
                    ...
                    <div className="md:hidden text-center mb-12">
                        ...
                        <h1 className="text-3xl font-black tracking-tighter uppercase mb-4">BUILDER EXONE</h1>
                        <div className="h-1 w-12 bg-black mx-auto"></div>
                    </div>

                    <div className="max-w-sm mx-auto w-full">
                        <div className="mb-10 text-left">
                            <div className="text-zinc-400 text-3xl font-light mb-4">✱</div>
                        ...
                        <form onSubmit={handleAuth} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full border-b-2 border-zinc-100 bg-transparent px-1 py-3 focus:border-black outline-none transition-all text-sm font-bold"
                            ...
                            <Button type="submit" className="w-full py-4 rounded-xl text-xs uppercase font-black tracking-widest shadow-xl shadow-zinc-200 hover:shadow-none transition-all mt-4" disabled={loading}>
